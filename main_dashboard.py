...
class DashboardApp:
    ...
    def _create_layout(self):
        ...
        stores = [
            dcc.Store(id='simulation-state-store', data={
                ...
                'start_interval': 0,
                'soc_offset': 0.0 # <-- Nuevo estado para el SOC acumulado
            })
        ]
        ...
        metrics_sidebar = html.Div(className="metrics-sidebar", children=[
            ...
            # --- CAMBIO DE ESTILO: Usamos 'metric-card' para unificar ---
    ...
    def _register_callbacks(self):
        ...
        def initialize_map_and_simulation(trip_id, n_intervals):
            ...
            # --- CAMBIO: El estado de reseteo ahora incluye el soc_offset ---
        ...
        def update_simulation_dashboard(n_intervals, vehicle_id, trip_id, sim_state):
            ...
            if duration > 0 and elapsed_time >= duration:
                ...
                sim_state['soc_offset'] += soc_consumido_por_viaje # Acumula el SOC consumido
                elapsed_time = 0
            ...
            # --- CAMBIO: El SOC ahora considera el offset acumulado ---
